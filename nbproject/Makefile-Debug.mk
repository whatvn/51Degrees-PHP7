...
${OBJECTDIR}/_ext/ad299da8/51Degree-PHP7.o: /Users/Hung/NetBeansProjects/51Degree-PHP7/51Degree-PHP7.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/ad299da8/51Degree-PHP7.o /Users/Hung/NetBeansProjects/51Degree-PHP7/51Degree-PHP7.cpp
...
${OBJECTDIR}/_ext/98b06f4f/json11.o: /Users/Hung/NetBeansProjects/51Degree-PHP7/json11/json11.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/98b06f4f/json11.o /Users/Hung/NetBeansProjects/51Degree-PHP7/json11/json11.cpp

${OBJECTDIR}/deviceDetection/cityhash/city.o: deviceDetection/cityhash/city.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/cityhash
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/cityhash/city.o deviceDetection/cityhash/city.c

${OBJECTDIR}/deviceDetection/console/Console.o: deviceDetection/console/Console.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/console
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/console/Console.o deviceDetection/console/Console.c

${OBJECTDIR}/deviceDetection/console/Console.o: deviceDetection/console/Console.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/console
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/console/Console.o deviceDetection/console/Console.cpp
...
${OBJECTDIR}/deviceDetection/pattern/51Degrees.o: deviceDetection/pattern/51Degrees.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/51Degrees.o deviceDetection/pattern/51Degrees.c

${OBJECTDIR}/deviceDetection/pattern/51Degrees.o: deviceDetection/pattern/51Degrees.i 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/51Degrees.o deviceDetection/pattern/51Degrees.i

${OBJECTDIR}/deviceDetection/pattern/51Degrees_PHP.o: deviceDetection/pattern/51Degrees_PHP.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/51Degrees_PHP.o deviceDetection/pattern/51Degrees_PHP.cpp

${OBJECTDIR}/deviceDetection/pattern/51Degrees_csharp.o: deviceDetection/pattern/51Degrees_csharp.cxx 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/51Degrees_csharp.o deviceDetection/pattern/51Degrees_csharp.cxx

${OBJECTDIR}/deviceDetection/pattern/51Degrees_node.o: deviceDetection/pattern/51Degrees_node.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/51Degrees_node.o deviceDetection/pattern/51Degrees_node.cpp

${OBJECTDIR}/deviceDetection/pattern/51Degrees_perl.o: deviceDetection/pattern/51Degrees_perl.cxx 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/51Degrees_perl.o deviceDetection/pattern/51Degrees_perl.cxx

${OBJECTDIR}/deviceDetection/pattern/Match.o: deviceDetection/pattern/Match.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/Match.o deviceDetection/pattern/Match.cpp

${OBJECTDIR}/deviceDetection/pattern/PerfPat.o: deviceDetection/pattern/PerfPat.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/PerfPat.o deviceDetection/pattern/PerfPat.c

${OBJECTDIR}/deviceDetection/pattern/ProcPat.o: deviceDetection/pattern/ProcPat.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/ProcPat.o deviceDetection/pattern/ProcPat.c

${OBJECTDIR}/deviceDetection/pattern/Profiles.o: deviceDetection/pattern/Profiles.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/Profiles.o deviceDetection/pattern/Profiles.cpp

${OBJECTDIR}/deviceDetection/pattern/Provider.o: deviceDetection/pattern/Provider.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/pattern
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/pattern/Provider.o deviceDetection/pattern/Provider.cpp

${OBJECTDIR}/deviceDetection/threading.o: deviceDetection/threading.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/threading.o deviceDetection/threading.c

${OBJECTDIR}/deviceDetection/trie/51Degrees.o: deviceDetection/trie/51Degrees.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/trie
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/trie/51Degrees.o deviceDetection/trie/51Degrees.c

${OBJECTDIR}/deviceDetection/trie/51Degrees.o: deviceDetection/trie/51Degrees.i 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/trie
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/trie/51Degrees.o deviceDetection/trie/51Degrees.i

${OBJECTDIR}/deviceDetection/trie/Match.o: deviceDetection/trie/Match.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/trie
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/trie/Match.o deviceDetection/trie/Match.cpp

${OBJECTDIR}/deviceDetection/trie/PerfTrie.o: deviceDetection/trie/PerfTrie.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/trie
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/trie/PerfTrie.o deviceDetection/trie/PerfTrie.c

${OBJECTDIR}/deviceDetection/trie/ProcTrie.o: deviceDetection/trie/ProcTrie.c 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/trie
	${RM} "$@.d"
	$(COMPILE.c) -g -IdeviceDetection -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/trie/ProcTrie.o deviceDetection/trie/ProcTrie.c

${OBJECTDIR}/deviceDetection/trie/Provider.o: deviceDetection/trie/Provider.cpp 
	${MKDIR} -p ${OBJECTDIR}/deviceDetection/trie
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deviceDetection/trie/Provider.o deviceDetection/trie/Provider.cpp
